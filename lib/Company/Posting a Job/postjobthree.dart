...
class PostJobthree extends StatefulWidget {
  const PostJobthree({super.key});

  @override
  State<PostJobthree> createState() => _PostJobthreeState();
}
...
class _PostJobthreeState extends State<PostJobthree> {
  @override
