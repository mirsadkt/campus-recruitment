            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  width: 300,
                  child: ElevatedButton(
                    onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => CompHome())),
                    child: Text(
                      "Login",
                      style: GoogleFonts.poppins(
                        letterSpacing: 1,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 13),
                      child: TextButton(
                        onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => CompSignup())),
                        child: Text(
                          "Sign Up",
                          style: GoogleFonts.poppins(
