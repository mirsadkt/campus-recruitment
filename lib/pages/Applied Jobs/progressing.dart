...
class AppliedjobsProgressing extends StatefulWidget {
  const AppliedjobsProgressing({super.key});

  @override
  State<AppliedjobsProgressing> createState() => _AppliedjobsProgressingState();
}

class _AppliedjobsProgressingState extends State<AppliedjobsProgressing> {
  @override
